...
export default function DashboardPage() {
    ...
    const { total_tasks, total_completed_tasks, total_in_progress_tasks, total_pending_tasks } = data.data
    return (
        <div className='w-full'>
            ...
            <Card title='In Progress Tasks' icon={Clock} value={total_in_progress_tasks} className={"text-orange-500"} />
        </div>
    </div>
    )
}